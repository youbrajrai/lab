                ...
                <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">Blood Reports</li>
                        </ul>
                    </div>
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                            <thead>
                                                <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                                                    ...
                                                    <th rowspan="3" class="p-0 pb-3 w-50px text-end">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @forelse($bloodReports as $bloodReport)
                                                    <tr>
                                                        <td>
                                                        ...
                                                        {{-- <td class="text-end">
                                                            <a target="_blank"
                                                                href="{{ route('bloodreport.serology.show', $bloodReport) }}"
                                                        ...
                                                        <td class="text-end">
                                                            <a target="_blank"
                                                                href="{{ route('blood-reports.show', $bloodReport) }}"
                                                                class="btn btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
                                                                Hematology
                                                            </a>
                                                        </td> --}}
                                                        ...
                                                        <td class="text-end">
                                                            <a href="{{ route('blood-reports.edit', $bloodReport) }}"
                                                                class="btn btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
                                                                Edit
                                                            </a>
                                                        </td>
