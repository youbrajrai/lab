                            ...
                            <div class="card card-flush h-675px">
                                <div class="card-body pb-0">
                                    <div class="table-responsive p-10 pb-0">
                                        <form data-kt-search-element="form" class="w-100 position-relative mt-10" method="POST" action="{{ route('bloodreport.serology.update', $bloodReport) }}">
                                            @csrf
                                            @method('PUT')
                                                    ...
                                                    <div class="row gx-10 gy-8 mb-18">
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="hbs_ag" aria-label="Select an Option" data-control="" data-placeholder="HBs-Ag" class="form-select form-select-md form-select-solid">
                                                                <option value="0" @if(old('hbs_ag', $bloodReport) == 0) selected @endif>Negative</option>
                                                                <option value="1" @if(old('hbs_ag', $bloodReport) == 1) selected @endif>Positive</option>
                                                            </select>
                                                            @error('hbs_ag')
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="anti_hiv" aria-label="Select an Option" data-control="" data-placeholder="Anti-HIV (1&amp;2)" class="form-select form-select-md form-select-solid">
                                                                <option value="0" @if(old('anti_hiv', $bloodReport) == 0) selected @endif >None Reactive</option>
                                                                <option value="1" @if(old('anti_hiv', $bloodReport) == 1) selected @endif >Reactive</option>
                                                            </select>
                                                            @error('anti_hiv')
                                                            <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="anti_hcv" aria-label="Select an Option" data-control="" data-placeholder="Anti-HCV" class="form-select form-select-md form-select-solid">
                                                                <option value="0" @if(old('anti_hcv', $bloodReport) == 0) selected @endif>Negative</option>
                                                                <option value="1" @if(old('anti_hcv', $bloodReport) == 1) selected @endif>Positive</option>
                                                            </select>
                                                            @error('anti_hcv')
                                                            <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="vdrl" aria-label="Select an Option" data-control="" data-placeholder="VDRL" class="form-select form-select-md form-select-solid">
                                                                <option value="0" @if(old('vdrl', $bloodReport) == 0) selected @endif>None Reactive</option>
                                                                <option value="1" @if(old('vdrl', $bloodReport) == 1) selected @endif>Reactive</option>
                                                            </select>
                                                            @error('vdrl')
                                                            <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="tpha" aria-label="Select an Option" data-control="" data-placeholder="TPHA" class="form-select form-select-md form-select-solid">
                                                                <option value="0" @if(old('tpha', $bloodReport) == 0) selected @endif>None Reactive</option>
                                                                <option value="1" @if(old('tpha', $bloodReport) == 1) selected @endif>Reactive</option>
                                                            </select>
                                                            @error('tpha')
                                                            <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="malarial_parasites" aria-label="Select an Option" data-control="" data-placeholder="Malaria Parasite" class="form-select form-select-md form-select-solid">
                                                                <option value="0" @if(old('malarial_parasites', $bloodReport) == 0) selected @endif>Absent</option>
                                                                <option value="1" @if(old('malarial_parasites', $bloodReport) == 1) selected @endif>Present</option>
                                                            </select>
                                            ...
                                            <div class="d-flex align-items-center gap-2 gap-lg-3 my-6">
                                                <a href = "{{route('bloodreport.differential.edit', $bloodReport)}}" class="btn btn-sm fw-bold btn-danger">Back</a>
