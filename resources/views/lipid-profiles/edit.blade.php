                ...
                <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">Edit Lipid Profile</li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                class="text-decoration-none text-black">udclab.com</a>
                                    ...
                                    <div class="table-responsive px-10 pt-0 pb-10">
                                        ...
                                        <form data-kt-search-element="form" class="w-100 position-relative mt-10"
                                            method="POST" action="{{ route('lipid-profiles.update', $lipidProfile) }}">
                                            @method('PUT')
                                            @csrf
                                            ...
                                            <div class="row border gx-10 gy-8 w-lg-100 ms-0 mt-0">
                                                ...
                                                <div class="col-3 border-bottom mt-0">
                                                    <input type="number" class="form-control py-2 my-2" name="age"
                                                        value="{{ old('age', $lipidProfile) }}" placeholder="Age"
                                                ...
                                                <div class="col-3 border-bottom border-end mt-0">
                                                    <select name="sex" aria-label="Select an Option"
                                                        ...
                                                        <option value="male" @selected($lipidProfile->sex === 'male')>
                                                            Male
                                                        </option>
                                                        <option value="female" @selected($lipidProfile->sex === 'female')>
                                                            Female
                                                        </option>
                                                    </select>
                                                    @error('sex')
                                                ...
                                                <div class="col-3 border-bottom mt-0">
                                                    <input type="date" class="form-control my-2 py-2"
                                                        ...
                                                        value="{{ old('medical_examination_date', $lipidProfile) }}"
                                                        data-kt-search-element="input" />
                                                ...
                                                <div class="col-3 mt-0 border-bottom border-end">
                                                    <input type="text" class="form-control py-2 my-2" name="address"
                                                        placeholder="Address" value="{{ old('address', $lipidProfile) }}"
                                                        data-kt-search-element="input" />
                                                    @error('address')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-3 mt-0 border-bottom">
                                                    <input type="text" class="form-control py-2 my-2" name="contact"
                                                        ...
                                                        value="{{ old('contact', $lipidProfile) }}"
                                                        data-kt-search-element="input" />
                                                    @error('contact')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-3 mt-0 border-end">
                                                    <input type="text" class="form-control py-2 my-2"
                                                        ...
                                                        value="{{ old('referred_by', $lipidProfile) }}"
                                                        data-kt-search-element="input" />
                                                    @error('referred_by')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" class="form-control py-2 my-2" name="lab"
                                                        placeholder="Lab No." value="{{ old('lab', $lipidProfile) }}"
                                                        data-kt-search-element="input" />
                                                    @error('lab')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="row gx-10 gy-8 mx-0 mt-0">
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control my-2 py-2"
                                                        ...
                                                        value="{{ old('total_cholestrol', $lipidProfile) }}"
                                                        data-kt-search-element="input"
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control my-2 py-2"
                                                        name="hdl_cholestrol"
                                                        value="{{ old('hdl_cholestrol', $lipidProfile) }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span> mg%</span> --}}
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control my-2 py-2"
                                                        name="ldl_cholestrol"
                                                        value="{{ old('ldl_cholestrol', $lipidProfile) }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span> mg%</span> --}}
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control my-2 py-2"
                                                        name="triglyceride"
                                                        value="{{ old('triglyceride', $lipidProfile) }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span> mg%</span> --}}
                                                    @error('triglyceride')
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="text" step="any" class="form-control py-2 my-2"
                                                        name="others" value="{{ old('others', $lipidProfile) }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span> u/l</span> --}}
                                                    @error('others')
