                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                            ...
                                            @forelse($systemics as $systemic)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="d-flex justify-content-start flex-column">
                                                                ...
                                                                <span class="text-gray-400 fw-semibold d-block fs-7">{{$systemic->pulmonary}}</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-end">
                                                        <a href="{{ route('systemics.edit', $report)}}" class="btn btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
                                                            Edit
                                                        </a>
                                                    </td>
                                                </tr>
