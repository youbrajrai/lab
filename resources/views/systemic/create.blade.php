                ...
                <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                            Create Systemic Examination Report
                        </h1>
                                                    ...
                                                    <div class="row gx-10 gy-8 mb-14">
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="cardiovascular" aria-label="Select an Option"
                                                                ...
                                                                <option value="NAD"
                                                                    @if (old('cardiovascular') == 'NAD') selected @endif>NAD
                                                                </option>
                                                                {{-- <option value="Present"
                                                                    @if (old('cardiovascular') == 'Present') selected @endif>
                                                                    Present</option> --}}
                                                            </select>
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="pulmonary" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="NAD"
                                                                    @if (old('pulmonary') == 'NAD') selected @endif>NAD
                                                                </option>
                                                                {{-- <option value="Present"
                                                                    @if (old('pulmonary') == 'Present') selected @endif>
                                                                    Present</option> --}}
                                                            </select>
                                                            @error('pulmonary')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="gastroenterology" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="NAD"
                                                                    @if (old('gastroenterology') == 'NAD') selected @endif>NAD
                                                                </option>
                                                                {{-- <option value="Present"
                                                                    @if (old('gastroenterology') == 'Present') selected @endif>
                                                                    Present</option> --}}
                                                            </select>
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="neurology" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="NAD"
                                                                    @if (old('neurology') == 'NAD') selected @endif>NAD
                                                                </option>
                                                                {{-- <option value="Present"
                                                                    @if (old('neurology') == 'Present') selected @endif>
                                                                    Present</option> --}}
                                                            </select>
                                                            @error('neurology')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="musculoskeletal" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="NAD"
                                                                    @if (old('musculoskeletal') == 'NAD') selected @endif>NAD
                                                                </option>
                                                                {{-- <option value="Present"
                                                                    @if (old('musculoskeletal') == 'Present') selected @endif>
                                                                    Present</option> --}}
                                                            </select>
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="genitourinary" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="NAD"
                                                                    @if (old('genitourinary') == 'NAD') selected @endif>NAD
                                                                </option>
                                                                {{-- <option value="Present"
                                                                    @if (old('genitourinary') == 'Present') selected @endif>
                                                                    Present</option> --}}
                                                            </select>
                                                            @error('genitourinary')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="dental" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="1"
                                                                    @if (old('dental') == 1) selected @endif>
                                                                    Normal</option>
                                                                {{-- <option value="0"
                                                                    @if (old('dental') == 0) selected @endif>
                                                                    Infected</option> --}}
                                                            </select>
                                                            @error('dental')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="extremities_deformities"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="NAD"
                                                                    @if (old('extremities_deformities') == 'NAD') selected @endif>NAD
                                                                </option>
                                                                {{-- <option value="Present"
                                                                    @if (old('extremities_deformities') == 'Present') selected @endif>
                                                                    Present</option> --}}
                                                            </select>
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="varicose_veins" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="0"
                                                                    @if (old('varicose_veins') == 0) selected @endif>
                                                                    Absent</option>
                                                                {{-- <option value="1"
                                                                    @if (old('varicose_veins') == 1) selected @endif>
                                                                    Present</option> --}}
                                                            </select>
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="hernia" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="0"
                                                                    @if (old('hernia') == 0) selected @endif>
                                                                    Absent</option>
                                                                {{-- <option value="1"
                                                                    @if (old('hernia') == 1) selected @endif>
                                                                    Present</option> --}}
                                                            </select>
                                                            @error('hernia')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="hydrocele" aria-label="Select an Option"
                                                                ...
                                                                {{-- <option value="Infected"
                                                                    @if (old('hydrocele') == 'Infected') selected @endif>
                                                                    Infected</option> --}}
                                                            </select>
                                                            @error('hydrocele')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="left_eye" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                {{-- <option value="1/6"
                                                                    @if (old('left_eye') == '1/6') selected @endif>1/6
                                                                </option> --}}
                                                                {{-- <option value="2/6"
                                                                    @if (old('left_eye') == '2/6') selected @endif>2/6
                                                                </option> --}}
                                                                {{-- <option value="3/6"
                                                                    @if (old('left_eye') == '3/6') selected @endif>3/6
                                                                </option> --}}
                                                                {{-- <option value="4/6"
                                                                    @if (old('left_eye') == '4/6') selected @endif>4/6
                                                                </option> --}}
                                                                {{-- <option value="5/6"
                                                                    @if (old('left_eye') == '5/6') selected @endif>5/6
                                                                </option> --}}
                                                                <option value="6/6"
                                                                    @if (old('left_eye') == '6/6') selected @endif>6/6
                                                                </option>
                                                            </select>
                                                            @error('left_eye')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="right_eye" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                {{-- <option value="1/6"
                                                                    @if (old('right_eye') == '1/6') selected @endif>1/6
                                                                </option> --}}
                                                                {{-- <option value="2/6"
                                                                    @if (old('right_eye') == '2/6') selected @endif>2/6
                                                                </option> --}}
                                                                {{-- <option value="3/6"
                                                                    @if (old('right_eye') == '3/6') selected @endif>3/6
                                                                </option> --}}
                                                                {{-- <option value="4/6"
                                                                    @if (old('right_eye') == '4/6') selected @endif>4/6
                                                                </option> --}}
                                                                {{-- <option value="5/6"
                                                                    @if (old('right_eye') == '5/6') selected @endif>5/6
                                                                </option> --}}
                                                                <option value="6/6"
                                                                    @if (old('right_eye') == '6/6') selected @endif>6/6
                                                                </option>
                                                            </select>
                                                            @error('right_eye')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="left_ear" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="1"
                                                                    @if (old('left_ear') == 1) selected @endif>
                                                                    Normal</option>
                                                                {{-- <option value="0"
                                                                    @if (old('left_ear') == 0) selected @endif>Bad
                                                                </option> --}}
                                                            </select>
                                                            @error('left_ear')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="right_ear" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="1"
                                                                    @if (old('right_ear') == 1) selected @endif>
                                                                    Normal</option>
                                                                {{-- <option value="0"
                                                                    @if (old('right_ear') == 0) selected @endif>Bad
                                                                </option> --}}
                                                            </select>
                                                            @error('right_ear')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="chest_x_ray" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="1"
                                                                    @if (old('chest_x_ray') == 1) selected @endif>
                                                                    Normal</option>
                                                                {{-- <option value="0"
                                                                    @if (old('chest_x_ray') == 0) selected @endif>Bad
                                                                </option> --}}
                                                            </select>
                                                            @error('chest_x_ray')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="ecg" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="1"
                                                                    @if (old('ecg') == 1) selected @endif>
                                                                    Normal</option>
                                                                {{-- {{-- <option value="0"
                                                                    @if (old('ecg') == 0) selected @endif>Bad
                                                                </option> --}}
                                                            </select>
                                                            @error('ecg')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="clinical_impression"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="1"
                                                                    @if (old('clinical_impression') == 1) selected @endif>
                                                                    Normal</option>
                                                                {{-- <option value="0"
                                                                    @if (old('clinical_impression') == 0) selected @endif>Bad
                                                                </option> --}}
                                                            </select>
