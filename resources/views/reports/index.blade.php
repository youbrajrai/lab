                                                ...
                                                @forelse($reports as $key => $report)
                                                    <tr>
                                                        ...
                                                        {{-- <td class="text-center">
                                                            <a target="_blank"
                                                                href="{{ route('reports.pathology', $report) }}"
                                                        ...
                                                        <td class="text-center">
                                                            <a target="_blank"
                                                                href="{{ route('reports.hematology', $report) }}"
                                                                class="btn btn-icon btn-active-color-primary w-auto h-30px">
                                                                View
                                                            </a>
                                                        </td>
                                                        <td class="text-center">
                                                            <a target="_blank"
                                                                href="{{ route('reports.biochemistry', $report) }}"
                                                                class="btn btn-icon btn-active-color-primary w-auto h-30px">
                                                                View
                                                            </a>
                                                        </td>
                                                        <td class="text-center">
                                                            <a target="_blank" href="{{ route('reports.kidney', $report) }}"
                                                                class="btn btn-icon btn-active-color-primary w-auto h-30px">
                                                                View
                                                            </a>
                                                        </td>
                                                        <td class="text-center">
                                                            <a target="_blank" href="{{ route('reports.liver', $report) }}"
                                                                class="btn btn-icon btn-active-color-primary w-auto h-30px">
                                                                View
                                                            </a>
                                                        </td>
