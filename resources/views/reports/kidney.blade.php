        ...
        <div class="tab-pane fade show active" id="kt_stats_widget_16_tab_1">
            ...
            <div class="table-responsive px-20 pt-0 pb-10 ">
                ...
                <div class="row gx-10 gy-8 w-lg-100 ms-0 mt-0">
                    ...
                    <div class="col-3 border border-start-0 border-end-0">
                        <h6 class="mb-0 py-2">Blood: {{!is_null($serology)?$serology->blood_group:'N/A'}}</h6>
                    </div>
                    <div class="col-3 border border-start-0">
                        <h6 class="mb-0 py-2"></h6>
                    </div>
                ...
                <div class="row gx-10 gy-8 mx-0 mt-0">
                    ...
                    <div class="col-6 mt-0">
                        <p class="mb-0 py-2">Uric Acid Male</p>
                    </div>
                    <div class="col-3 mt-0">
                        <p class="mb-0 py-2">{{!is_null($biochemistry)?$biochemistry->uricacidmale . 'mmpl/L': 'N/A'}}</p>
                    </div>
                    <div class="col-3 mt-0">
                        <p class="mb-0 py-2">(3 - 7 mg)/dl</p>
                    </div>
                    <div class="col-6 mt-0">
                        <p class="mb-0 py-2">Uric Acid Female</p>
                    </div>
                    <div class="col-3 mt-0">
                        <p class="mb-0 py-2">{{!is_null($biochemistry)?$biochemistry->uricacidfemale . 'mmpl/L': 'N/A'}}</p>
                    </div>
                    <div class="col-3 mt-0">
                        <p class="mb-0 py-2">(2 - 6 mg)/dl</p>
                    </div>
                </div>
