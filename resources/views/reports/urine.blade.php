    ...
    <div class="tab-content print_report">
        <div class="tab-pane fade show active" id="kt_stats_widget_16_tab_1">
            ...
            <div class="table-responsive px-20 pt-0 pb-10 ">
                ...
                <div class="row gx-10 gy-8 w-lg-100 ms-0 mt-0">
                    <h1 class="text-center border border-dark border-3 pt-2 pb-2">Urine Examination Report</h1>
                </div>
                ...
                <div class="row gx-10 gy-8 mx-0 mt-0">
                    ...
                    <div class="col-3 mt-0">
                        <p class="mb-0 py-2">{{!is_null($urine)?$urine->urobilinogen . 'mg/dl': 'N/A'}} mg/dl</p>
                    </div>
                    <div class="col-3 mt-0">
                        <!--<p class="mb-0 py-2">(0.4-1.4) mg/dl</p>-->
                    </div>
                ...
                <div class="row gx-10 gy-8 mx-0 mt-0">
                    ...
                    <div class="col-3 mt-0">
                        <p class="mb-0 py-2">{{!is_null($urine)?$urine->pus_cells . '/hpf': 'N/A'}}</p>
                    </div>
                    <div class="col-3 mt-0">
                        <!--<p class="mb-0 py-2">(20-45) mg/dl</p>-->
                    </div>
                    ...
                    <div class="col-3 mt-0">
                        <p class="mb-0 py-2">{{!is_null($urine)?$urine->rbc_hpf . '/hpf' : 'N/A'}}</p>
                    </div>
                    <div class="col-3 mt-0">
                        <!--<p class="mb-0 py-2">(20-45) mg/dl</p>-->
                    </div>
                    ...
                    <div class="col-3 mt-0">
                        <p class="mb-0 py-2">{{!is_null($urine)?$urine->epithelial_cells . '/hpf':'N/A'}}</p>
                    </div>
                    <div class="col-3 mt-0">
                        <!--<p class="mb-0 py-2">(20-45) mg/dl</p>-->
                    </div>
                    ...
                    <div class="col-3 mt-0">
                        <p class="mb-0 py-2">{{!is_null($urine)?$urine->urates.'/hpf': 'N/A'}}</p>
                    </div>
                    <div class="col-3 mt-0">
                        <!--<p class="mb-0 py-2">(20-45) mg/dl</p>-->
                    </div>
                    ...
                    <div class="col-3 mt-0">
                        <p class="mb-0 py-2">{{!is_null($urine)?$urine->casts.'/hpf':'N/A'}}</p>
                    </div>
                    <div class="col-3 mt-0">
                        <!--<p class="mb-0 py-2">(20-45) mg/dl</p>-->
                    </div>
                    ...
                    <div class="col-3 mt-0">
                        <p class="mb-0 py-2">{{!is_null($urine)?$urine->ca_oxalate . '/hpf':'N/A'}}</p>
                    </div>
                    <div class="col-3 mt-0">
                        <!--<p class="mb-0 py-2">(20-45) mg/dl</p>-->
                    </div>
