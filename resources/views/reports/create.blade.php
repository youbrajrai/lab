                                                    ...
                                                    <div class="row gx-10 gy-8 mb-14">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <input type="text" class="form-control" name="nationality"
                                                                placeholder="Nationality" value = "Nepali"
                                                                data-kt-search-element="input" />
                                                            @error('nationality')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="passport_issue_place"
                                                                aria-label="Select an Option" data-control="select2"
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="{{ old('passport_issue_place') }}"
                                                                    label="Passport Issue Place" selected="selected"
                                                                    disabled>Passport Issue Place</option>
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"
                                                                                id="exampleModalLabel">Applicant Current
                                                                                Photo</h5>
                                                                            <button type="button" class="close"
                                                                                data-bs-dismiss="modal" aria-label="Close"
                                                                                onClick=Webcam.reset()>
                                                                                <i aria-hidden="true"
                                                                                    class="ki ki-plus ki-cross"></i>
                                                                            </button>
                                                                        </div>
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button"
                                                                                ...
                                                                                onClick=Webcam.reset()>Close</button>
                                                                            <input type="button"
