                                ...
                                <div class="card-body p-15 pe-0 pb-0">
                                    <div class="table-responsive h-550px pe-15">
                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                            ...
                                            <tbody>
                                                @forelse($cannabiesPregnancyTests as $cannabiesPregnancyTest)
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <p
                                                                    class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">
                                                                    {{ $cannabiesPregnancyTest->id }}
                                                                </p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td class="text-end">
                                                            <a target="_blank"
                                                                href="{{ route('cannabies-pregnancy-tests.show', $cannabiesPregnancyTest) }}"
