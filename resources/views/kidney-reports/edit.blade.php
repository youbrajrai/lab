                                ...
                                class="text-decoration-none text-gray-800">{{ $user->website }}</a>
                                    ...
                                    <div class="table-responsive px-10 pt-0 pb-10">
                                        ...
                                        <form data-kt-search-element="form" class="w-100 position-relative mt-10"
                                            method="POST" action="{{ route('kidney-reports.update', $kidneyReport) }}">
                                            @method('PUT')
                                            @csrf
                                            <div class="row border gx-10 gy-8 w-lg-100 ms-0 mt-0">
                                                ...
                                                <div class="col-3 border-bottom mt-0">
                                                    <input type="number" class="form-control py-2 my-2" name="age"
                                                        value="{{ old('age', $kidneyReport) }}" placeholder="Age"
                                                ...
                                                <div class="col-3 border-bottom border-end mt-0">
                                                    <select name="sex" aria-label="Select an Option"
                                                        ...
                                                        <option value="male" @selected($kidneyReport->sex === 'male')>
                                                            Male
                                                        </option>
                                                        <option value="female" @selected($kidneyReport->sex === 'female')>
                                                            Female
                                                        </option>
                                                    </select>
                                                    @error('sex')
                                                ...
                                                <div class="col-3 border-bottom mt-0">
                                                    <select name="marital_status" aria-label="Select an Option"
                                                        ...
                                                        <option value="single" @selected($kidneyReport->marital_status === 'single')>
                                                            Single
                                                        </option>
                                                        <option value="married" @selected($kidneyReport->marital_status === 'married')>
                                                            Married
                                                        </option>
                                                    </select>
                                                ...
                                                <div class="col-3 border-bottom border-end mt-0">
                                                    <input type="date" class="form-control my-2"
                                                        ...
                                                        value="{{ old('medical_examination_date', $kidneyReport) }}"
                                                        data-kt-search-element="input" />
                                                ...
                                                <div class="col-3 mt-0 border-bottom">
                                                    <input type="text" class="form-control my-2" name="referred_by"
                                                        ...
                                                        value="{{ old('referred_by', $kidneyReport) }}"
                                                        data-kt-search-element="input" />
                                                    @error('referred_by')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-3 mt-0 border-bottom border-end">
                                                    <input type="number" class="form-control my-2" name="lab"
                                                        placeholder="Lab No." value="{{ old('lab', $kidneyReport) }}"
                                                        data-kt-search-element="input" />
                                                    @error('lab')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-3 border-bottom mt-0">
                                                    <input type="text" class="form-control my-2" name="address"
                                                        placeholder="Address" value="{{ old('address', $kidneyReport) }}"
                                                        data-kt-search-element="input" />
                                                    @error('address')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="text" class="form-control my-2" name="contact"
                                                        ...
                                                        value="{{ old('contact', $kidneyReport) }}"
                                                        data-kt-search-element="input" />
                                                    @error('contact')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="row gx-10 gy-8 mx-0 mt-0">
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control py-2 my-2"
                                                        name="urea" value="{{ old('urea', $kidneyReport) }}"
                                                        data-kt-search-element="input"
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control py-2 my-2"
                                                        name="creatinine" value="{{ old('creatinine', $kidneyReport) }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span>mg/dl</span> --}}
                                                    @error('creatinine')
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control py-2 my-2"
                                                        name="sodium" value="{{ old('sodium', $kidneyReport) }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span>mmol/L</span> --}}
                                                    @error('sodium')
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control py-2 my-2"
                                                        name="potassium" value="{{ old('potassium', $kidneyReport) }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span>mmpl/L</span> --}}
                                                    @error('potassium')
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control py-2 my-2"
                                                        name="uric_acid_male"
                                                        value="{{ old('uric_acid_male', $kidneyReport) }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span>mg/dl</span> --}}
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control py-2 my-2"
                                                        name="uric_acid_female"
                                                        value="{{ old('uric_acid_female', $kidneyReport) }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span>mg/dl</span> --}}
