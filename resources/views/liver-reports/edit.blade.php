                ...
                <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                            Update Liver Function Test Details
                        </h1>
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">Edit Liver Function Test</li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                class="text-decoration-none text-black">udclab.com</a>
                                    ...
                                    <div class="table-responsive px-10 pt-0 pb-10">
                                        ...
                                        <form data-kt-search-element="form" class="w-100 position-relative mt-10"
                                            method="POST" action="{{ route('liver-reports.update', $liverReport) }}">
                                            @method('PUT')
                                            @csrf
                                            ...
                                            <div class="row border gx-10 gy-8 w-lg-100 ms-0 mt-0">
                                                ...
                                                <div class="col-3 border-bottom border-end mt-0">
                                                    <input type="text" class="form-control py-2 my-2" name="name"
                                                        value="{{ old('name', $liverReport) }}" placeholder="Patient's Name"
                                                ...
                                                <div class="col-3 border-bottom mt-0">
                                                    <input type="number" class="form-control py-2 my-2" name="age"
                                                        value="{{ old('age', $liverReport) }}" placeholder="Age"
                                                        data-kt-search-element="input" />
                                                    @error('age')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-3 border-bottom border-end mt-0">
                                                    <select name="sex" aria-label="Select an Option"
                                                        ...
                                                        <option value="male" @selected($liverReport->sex === 'male')>
                                                            Male
                                                        </option>
                                                        <option value="female" @selected($liverReport->sex === 'female')>
                                                            Female
                                                        </option>
                                                    </select>
                                                    @error('sex')
                                                ...
                                                <div
                                                    ...
                                                    <select name="marital_status" aria-label="Select an Option"
                                                        ...
                                                        class="form-select form-select-md form-select-solid mb-0 py-2 mb-2">
                                                        <option value="single" @selected($liverReport->marital_status === 'single')>Single
                                                        </option>
                                                        <option value="married" @selected($liverReport->marital_status === 'married')>Married
                                                        </option>
                                                    </select>
                                                ...
                                                <div class="col-3 border-bottom mt-0">
                                                    <input type="date" class="form-control my-2"
                                                        ...
                                                        value="{{ old('medical_examination_date', $liverReport) }}"
                                                        data-kt-search-element="input" />
                                                ...
                                                <div class="col-3 mt-0 border-bottom border-end">
                                                    <input type="text" class="form-control my-2" name="address"
                                                        placeholder="Address" value="{{ old('address', $liverReport) }}"
                                                        data-kt-search-element="input" />
                                                    @error('address')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-3 border-end mt-0">
                                                    <input type="text" class="form-control my-2" name="referred_by"
                                                        ...
                                                        value="{{ old('referred_by', $liverReport) }}"
                                                        data-kt-search-element="input" />
                                                    @error('referred_by')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-3 mt-0 border-end">
                                                    <input type="number" class="form-control my-2" name="lab"
                                                        placeholder="Lab No." value="{{ old('lab', $liverReport) }}"
                                                        data-kt-search-element="input" />
                                                    @error('lab')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="row gx-10 gy-8 mx-0 mt-0">
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control py-2 my-2"
                                                        ...
                                                        value="{{ old('sr_bilirubin_total', $liverReport) }}"
                                                        data-kt-search-element="input"
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control py-2 my-2"
                                                        ...
                                                        value="{{ old('sr_bilirubin_direct', $liverReport) }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span> mg%</span> --}}
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control py-2 my-2"
                                                        name="alkaline_phosphate"
                                                        value="{{ old('alkaline_phosphate', $liverReport) }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span> u/l</span> --}}
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control py-2 my-2"
                                                        name="sgpt" value="{{ old('sgpt', $liverReport) }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span> u/l</span> --}}
                                                    @error('sgpt')
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control py-2 my-2"
                                                        name="sgot" value="{{ old('sgot', $liverReport) }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span> u/l</span> --}}
                                                    @error('sgot')
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control py-2 my-2"
                                                        name="total_protein"
                                                        value="{{ old('total_protein', $liverReport) }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span> gm/dl</span> --}}
                                                    @error('total_protein')
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control py-2 my-2"
                                                        name="serum_albumin"
                                                        value="{{ old('serum_albumin', $liverReport) }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span> gm/dl</span> --}}
                                                    @error('serum_albumin')
