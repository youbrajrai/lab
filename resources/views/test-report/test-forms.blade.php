...
@section('content')
    <form action="{{ route('tests.process') }}" method="POST">
                ...
                <div class="m-0">
                    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                        <div class="d-flex flex-column flex-column-fluid">
                            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6 collapsible toggle active"
                                data-bs-toggle="collapse" data-bs-target="#kt_job_4_{{ $index }}" aria-expanded="true">
                            ...
                            <div id="kt_job_4_{{ $index }}" class="fs-6 ms-1 collapse show">
                                @include($partial, ['report' => $reportid])
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-3 mt-10">
            ...
            <button type="submit" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal"
                data-bs-target="#kt_modal_new_target">Save
            </button>
        </div>
    </form>
@endsection
