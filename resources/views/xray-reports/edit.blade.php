                                ...
                                class="text-decoration-none text-gray-800">{{ $user->website }}</a>
                                    ...
                                    <div class="table-responsive px-10 pt-0 pb-10">
                                        ...
                                        <form data-kt-search-element="form" class="w-100 position-relative mt-10"
                                            method="POST" action="{{ route('xray-reports.update', $xrayReport) }}">
                                            @method('PUT')
                                            @csrf
                                            <div class="row border gx-10 gy-8 w-lg-100 ms-0 mt-0">
                                                ...
                                                <div class="col-3 border-bottom border-end mt-0">
                                                    <input type="text" class="form-control my-2 py-2" name="name"
                                                        value="{{ old('name', $xrayReport) }}" placeholder="Patient's Name"
                                                ...
                                                <div class="col-3 border-bottom mt-0">
                                                    <input type="number" class="form-control my-2 py-2" name="age"
                                                        value="{{ old('age', $xrayReport) }}" placeholder="Age"
                                                        data-kt-search-element="input" />
                                                    @error('age')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-3 border-bottom border-end mt-0">
                                                    <select name="sex" aria-label="Select an Option"
                                                        ...
                                                        <option value="male" @selected($xrayReport->sex === 'male')>
                                                            Male
                                                        </option>
                                                        <option value="female" @selected($xrayReport->sex === 'female')>
                                                            Female
                                                        </option>
                                                    </select>
                                                    @error('sex')
                                                ...
                                                <div class="col-3 border-bottom mt-0">
                                                    <input type="text" class="form-control my-2" name="country"
                                                        placeholder="Address" value="{{ old('country', $xrayReport) }}"
                                                        data-kt-search-element="input" />
                                                    @error('country')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-3 border-bottom mt-0">
                                                    <select name="clinical_history" aria-label="Select an Option"
                                                        ...
                                                        <option value="Normal" @selected($xrayReport->clinical_history === 'Normal')>
                                                            Normal
                                                        </option>
                                                        <option value="Calcification" @selected($xrayReport->clinical_history === 'Calcification')>
                                                            Calcification</option>
                                                        <option value="Pleural thickening" @selected($xrayReport->clinical_history === 'Pleural thickening')>
                                                            Pleural thickening
                                                        </option>
                                                        <option value="fibrosis" @selected($xrayReport->clinical_history === 'fibrosis')>Fibrosis
                                                        </option>
                                                        <option value="Fibrocalcification"@selected($xrayReport->clinical_history === 'Fibrocalcification')>
                                                            Fibrocalcification</option>
                                                            <option value="Other" @selected($xrayReport->clinical_history === 'Other')>Other
                                                        </option>
                                                    </select>
                                                     ...
                                                     @if ($xrayReport->clinical_history === 'Other')
                                                        <input type="text" class="form-control py-2 my-2"
                                                            ...
                                                            value="{{ old('clinical_other', $xrayReport) }}"
                                                            data-kt-search-element="input" />
                                                    @else
                                                        <input type="text" class="form-control py-2 my-2"
                                                            name="clinical_other" id="other_clinical" value=""
                                                ...
                                                <div class="col-3 border-end mt-0">
                                                    <input type="text" class="form-control py-2 my-2"
                                                        ...
                                                        value="{{ old('requested_by', $xrayReport) }}"
                                                        data-kt-search-element="input" />
                                                    @error('requested_by')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-3 border-end mt-0">
                                                    <input type="date" class="form-control py-2 my-2"
                                                        ...
                                                        value="{{ old('medical_examination_date', $xrayReport) }}"
                                                        data-kt-search-element="input" />
                                            ...
                                            <div class="gx-10 gy-8 mx-0 mt-2">
                                                ...
                                                {{-- <div class="mb-5 mt-0">
                                                    <textarea class="form-control form-control-solid" rows="4" id="radiologist_opinion"
                                                        name="radiologist_opinion">{{ $xrayReport->radiologist_opinion }}</textarea>
                                                </div> --}}
                                                ...
                                                <div class="row align-items-center mt-10 mb-5">
                                                    ...
                                                    <div class="col-3 mt-0">
                                                        <select name="defect_seen" aria-label="Select an Option"
                                                            ...
                                                            <option value="Normal" @selected($xrayReport->defect_seen === 'Normal')>
                                                                Normal
                                                            </option>
                                                            <option value="Calcification" @selected($xrayReport->defect_seen === 'Calcification')>
                                                                Calcification</option>
                                                            <option value="Pleural thickening"
                                                                @selected($xrayReport->defect_seen === 'Pleural thickening')>Pleural thickening
                                                            </option>
                                                            <option value="Fibrosis" @selected($xrayReport->defect_seen === 'fibrosis')>Fibrosis
                                                            </option>
                                                            <option
                                                                value="Fibrocalcification"@selected($xrayReport->defect_seen === 'Fibrocalcification')>
                                                                Fibrocalcification</option>
                                                                <option value="Other" @selected($xrayReport->defect_seen === 'Other')>Other
                                                            </option>
                                                        </select>
                                                        
                                                        @if ($xrayReport->defect_seen === 'Other')
                                                            <input type="text" class="form-control py-2 my-2"
                                                                name="other" id="other_defect"
                                                                value="{{ old('other', $xrayReport) }}"
                                                                data-kt-search-element="input" />
                                                        @else
                                                            <input type="text" class="form-control py-2 my-2"
                                                                name="other" id="other_defect" value=""
                                                                data-kt-search-element="input" style="display: none;" />
                                                        @endif
