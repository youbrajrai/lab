                ...
                <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">Serology Reports</li>
                        </ul>
                    </div>
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <a href="{{ route('serology-reports.create') }}" class="btn btn-sm fw-bold btn-primary">New
                            Report</a>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-body p-15 pe-0 pb-0">
                                    <div class="table-responsive h-550px pe-15">
                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                            ...
                                            <tbody>
                                                @forelse($serologyReports as $serologyReport)
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td class="text-end">
                                                            <a target="_blank"
                                                                href="{{ route('serology-reports.show', $serologyReport) }}"
                                                                class="btn btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
                                                                Print
                                                            </a>
                                                        </td>
                                                        <td class="text-end">
                                                            <a href="{{ route('serology-reports.edit', $serologyReport) }}"
                                                                class="btn btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
                                                                Edit
                                                            </a>
                                                        </td>
