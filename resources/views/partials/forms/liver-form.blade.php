                 ...
                 <div class="card card-flush mb-8">
                     <div class="card-body px-20 py-10">
                         ...
                         <div class="table-responsive px-10 pt-0 pb-10">
                             ...
                             <form data-kt-search-element="form" class="w-100 position-relative mt-10" method="POST" action="{{ route('liver-reports.store') }}">
                                 @csrf
                         ...
                         <div class="row gx-10 gy-8 mx-0 mt-0">
                             ...
                             <div class="col-3 mt-0">
                                 <input type="number" step="any" class="form-control my-2 py-2" name="sr_bilirubin_total" value="{{ old('sr_bilirubin_total') }}" data-kt-search-element="input" style="width:50%; display: inline;">
                                 {{-- <span> mg%</span> --}}
                             ...
                             <div class="col-3 mt-0">
                                 <input type="number" step="any" class="form-control my-2 py-2" name="sr_bilirubin_direct" value="{{ old('sr_bilirubin_direct') }}" data-kt-search-element="input" style="width:50%; display: inline;">
                                 {{-- <span> mg%</span> --}}
                             ...
                             <div class="col-3 mt-0">
                                 <input type="number" step="any" class="form-control my-2 py-2" name="alkaline_phosphate" value="{{ old('alkaline_phosphate') }}" data-kt-search-element="input" style="width:50%; display: inline;">
                                 {{-- <span> u/l</span> --}}
                             ...
                             <div class="col-3 mt-0">
                                 <input type="number" step="any" class="form-control my-2 py-2" name="sgpt" value="{{ old('sgpt') }}" data-kt-search-element="input" style="width:50%; display: inline;">
                                 {{-- <span> u/l</span> --}}
                                 @error('sgpt')
                                 <span class="invalid-feedback d-block" role="alert">
                                     <strong>{{ $message }}</strong>
                             ...
                             <div class="col-3 mt-0">
                                 <input type="number" step="any" class="form-control py-2 my-2" name="sgot" value="{{ old('sgot') }}" data-kt-search-element="input" style="width:50%; display: inline;">
                                 {{-- <span> u/l</span> --}}
                                 @error('sgot')
                                 <span class="invalid-feedback d-block" role="alert">
                                     <strong>{{ $message }}</strong>
                             ...
                             <div class="col-3 mt-0">
                                 <input type="number" step="any" class="form-control py-2 my-2" name="total_protein" value="{{ old('total_protein') }}" data-kt-search-element="input" style="width:50%; display: inline;">
                                 {{-- <span> gm/dl</span> --}}
                                 @error('total_protein')
                                 <span class="invalid-feedback d-block" role="alert">
                                     <strong>{{ $message }}</strong>
                             ...
                             <div class="col-3 mt-0">
                                 <input type="number" step="any" class="form-control py-2 my-2" name="serum_albumin" value="{{ old('serum_albumin') }}" data-kt-search-element="input" style="width:50%; display: inline;">
                                 {{-- <span> gm/dl</span> --}}
                                 @error('serum_albumin')
                                 <span class="invalid-feedback d-block" role="alert">
                                     <strong>{{ $message }}</strong>
