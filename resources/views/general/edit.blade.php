                ...
                <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                            Edit General Examination Report
                        </h1>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive p-10">
                                        ...
                                        <form data-kt-search-element="form" class="w-100 position-relative mt-10"
                                            method="POST"
                                            action="{{ route('reports.generals.update', $general->report_id) }}">
                                            @csrf
                                            @method('PUT')
                                                    ...
                                                    <div class="row gx-10 gy-8 mb-14">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <input type="number" step = "any" class="form-control"
                                                                name="height" value="{{ old('height', $general) }}"
                                                        ...
                                                        <div class="col-lg-4">
                                                            <h6>Weight</h6>
                                                            <input type="number" step = "any" class="form-control"
                                                                name="weight" value="{{ old('weight', $general) }}"
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            {{-- <input type="number" step="any" class="form-control"
                                                                ...
                                                                <option value="68"
                                                                    @if (old('pulse',$general) == 68) selected @endif>68
                                                                </option>
                                                                <option value="70"
                                                                    @if (old('pulse',$general) == 70) selected @endif>70
                                                                </option>
                                                                <option value="72"
                                                                    @if (old('pulse',$general) == 72) selected @endif>72
                                                                </option>
                                                                <option value="74"
                                                                    @if (old('pulse',$general) == 74) selected @endif>74
                                                                </option>
                                                                <option value="76"
                                                                    @if (old('pulse',$general) == 76) selected @endif>76
                                                                </option>
                                                            </select>
                                                            @error('pulse')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            {{-- <input type="number" step="any" class="form-control"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="96"
                                                                    @if (old('temperature',$general) == 96) selected @endif>96
                                                                </option>
                                                                <option value="96.5"
                                                                    @if (old('temperature',$general) == 96.5) selected @endif>96.5
                                                                </option>
                                                                <option value="97"
                                                                    @if (old('temperature',$general) == 97) selected @endif>97
                                                                </option>
                                                                <option value="98"
                                                                    @if (old('temperature',$general) == 98) selected @endif>98
                                                                </option>
                                                                <option value="99"
                                                                    @if (old('temperature',$general) == 99) selected @endif>99
                                                                </option>
                                                            </select>
                                                            @error('temperature')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <input type="text" class="form-control" name="blood_pressure"
                                                                value="{{ old('blood_pressure', $general) }}"
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="jaundice" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="0"
                                                                    @if (old('jaundice', $general) == 0) selected @endif>Absent
                                                                </option>
                                                                {{-- <option value="1"
                                                                    @if (old('jaundice', $general) == 1) selected @endif>
                                                                    Present</option> --}}
                                                            </select>
                                                            @error('jaundice')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="paller" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="0"
                                                                    @if (old('paller', $general) == 0) selected @endif>Absent
                                                                </option>
                                                                {{-- <option value="1"
                                                                    @if (old('paller', $general) == 1) selected @endif>
                                                                    Present</option> --}}
                                                            </select>
                                                            @error('paller')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="cynosis" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="0"
                                                                    @if (old('cynosis', $general) == 0) selected @endif>Absent
                                                                </option>
                                                                {{-- <option value="1"
                                                                    @if (old('cynosis', $general) == 1) selected @endif>
                                                                    Present</option> --}}
                                                            </select>
                                                            @error('cynosis')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="clubbing" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="0"
                                                                    @if (old('clubbing', $general) == 0) selected @endif>Absent
                                                                </option>
                                                                {{-- <option value="1"
                                                                    @if (old('clubbing', $general) == 1) selected @endif>
                                                                    Present</option> --}}
                                                            </select>
                                                            @error('clubbing')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="odema" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="0"
                                                                    @if (old('odema', $general) == 0) selected @endif>Absent
                                                                </option>
                                                                {{-- <option value="1"
                                                                    @if (old('odema', $general) == 1) selected @endif>
                                                                    Present</option> --}}
                                                            </select>
                                                            @error('odema')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="ascitis" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="0"
                                                                    @if (old('ascitis', $general) == 0) selected @endif>
                                                                    Absent</option>
                                                                {{-- <option value="1"
                                                                    @if (old('ascitis', $general) == 1) selected @endif>
                                                                    Present</option> --}}
                                                            </select>
                                                            @error('ascitis')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="lymph_node" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="0"
                                                                    @if (old('lymph_node', $general) == 0) selected @endif>
                                                                    Absent</option>
                                                                {{-- <option value="1"
                                                                    @if (old('lymph_node', $general) == 1) selected @endif>
                                                                    Present</option> --}}
                                                            </select>
                                                            @error('lymph_node')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="serious_illness" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="0"
                                                                    @if (old('serious_illness', $general) == 0) selected @endif>None
                                                                </option>
                                                                {{-- <option value="1"
                                                                    @if (old('serious_illness', $general) == 1) selected @endif>
                                                                    Present</option> --}}
                                                            </select>
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="allergy_history" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="0"
                                                                    @if (old('allergy_history', $general) == 0) selected @endif>None
                                                                </option>
                                                                {{-- <option value="1"
                                                                    @if (old('allergy_history', $general) == 1) selected @endif>
                                                                    Present</option> --}}
                                                            </select>
