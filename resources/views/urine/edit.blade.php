                                ...
                                <div class="card-body">
                                    <div class="table-responsive p-10">
                                        ...
                                        <form data-kt-search-element="form" class="w-100 position-relative mt-10"
                                            method="POST"
                                            action="{{ route('urines.update', $testData['urine']->report_id) }}">
                                            @csrf
                                            @method('PATCH')
                                                    ...
                                                    <div class="row gx-10 gy-8 mb-14" bis_skin_checked="1">
                                                        ...
                                                        {{-- <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="text" class="form-control" name="urine_color"
                                                                value="{{ old('urine_color', $testData['urine']) }}" placeholder="Color"
                                                        ...
                                                        {{-- <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="text" class="form-control" name="transparency"
                                                                value="{{ old('transparency', $testData['urine']) }}"
                                                        ...
                                                        {{-- <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="text" class="form-control" name="reaction"
                                                                value="{{ old('reaction', $testData['urine']) }}" placeholder="Reaction"
                                                                data-kt-search-element="input">
                                                            @error('reaction')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                        ...
                                                        <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="text" class="form-control" name="albumin_sugar"
                                                                value="{{ old('albumin_sugar', $testData['urine']) }}"
                                                                placeholder="Albumin/Sugar" data-kt-search-element="input"
                                                                readonly>
                                                            @error('albumin_sugar')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                        ...
                                                        {{-- <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="text" class="form-control" name="albumin"
                                                                value="{{ old('albumin', $testData['urine']) }}" placeholder="Albumin"
                                                                data-kt-search-element="input">
                                                            @error('albumin')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                        ...
                                                        <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="text" class="form-control" name="sugar"
                                                                value="{{ old('sugar', $testData['urine']) }}" placeholder="Sugar"
                                                                data-kt-search-element="input">
                                                            @error('urea')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                        ...
                                                        {{-- <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="text" class="form-control" name="urobilinogen"
                                                                value="{{ old('urobilinogen', $testData['urine']) }}"
                                                        ...
                                                        {{-- <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="text" class="form-control" name="bile_salt"
                                                                value="{{ old('bile_salt', $testData['urine']) }}"
                                                        ...
                                                        {{-- <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="bile_pigment"
                                                                value="{{ old('bile_pigment', $testData['urine']) }}"
                                                        ...
                                                        {{-- <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="text" class="form-control" name="acetone"
                                                                value="{{ old('acetone', $testData['urine']) }}"
                                                        ...
                                                        {{-- <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="ketone_bodies"
                                                                value="{{ old('ketone_bodies', $testData['urine']) }}"
                                                        ...
                                                        {{-- <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="text" class="form-control" name="nitrite"
                                                                value="{{ old('nitrite', $testData['urine']) }}"
                                                        ...
                                                        <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="text" class="form-control" name="pus_cells"
                                                                value="{{ old('pus_cells', $testData['urine']) }}"
                                                        ...
                                                        <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="text" class="form-control" name="rbc_hpf"
                                                                value="{{ old('rbc_hpf', $testData['urine']) }}"
                                                                placeholder="RBC-hpf" data-kt-search-element="input"
                                                                readonly>
                                                            @error('rbc_hpf')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                        ...
                                                        <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ old('epithelial_cells', $testData['urine']) }}"
                                                        ...
                                                        {{-- <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="number" class="form-control" name="urates"
                                                                value="{{ old('urates', $testData['urine']) }}" placeholder="Urates"
                                                                data-kt-search-element="input">
                                                            @error('urates')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                        ...
                                                        {{-- <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="number" class="form-control" name="casts"
                                                                value="{{ old('casts', $testData['urine']) }}" placeholder="Casts"
                                                                data-kt-search-element="input">
                                                            @error('casts')
                                                                <span class="invalid-feedback d-block" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                        ...
                                                        {{-- <div class="col-lg-4" bis_skin_checked="1">
                                                            ...
                                                            <input type="number" class="form-control" name="ca_oxalate"
                                                                value="{{ old('ca_oxalate', $testData['urine']) }}"
