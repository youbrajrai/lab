                                    ...
                                    <div class="table-responsive p-10">
                                        ...
                                        <form data-kt-search-element="form" class="w-100 position-relative mt-10"
                                                    ...
                                                    <div class="row gx-10 gy-8 mb-14">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select name="blood_group" aria-label="Select an Option"
                                                                ...
                                                                class="form-select form-select-md form-select-solid">
                                                                <option value="O+ve"
                                                                    @if (old('blood_group') == 'O+ve') selected @endif>O+ve
                                                                </option>
                                                                <option value="A+ve"
                                                                    @if (old('blood_group') == 'A+ve') selected @endif>A+ve
                                                                </option>
                                                                <option value="B+ve"
                                                                    @if (old('blood_group') == 'B+ve') selected @endif>B+ve
                                                                </option>
                                                                <option value="AB+ve"
                                                                    @if (old('blood_group') == 'AB+ve') selected @endif>
                                                                    AB+ve</option>
                                                                <option value="O-ve"
                                                                    @if (old('blood_group') == 'O-ve') selected @endif>O-ve
                                                                </option>
                                            ...
                                            <div class="d-flex align-items-center gap-2 gap-lg-3 my-6">
                                                ...
                                                {{-- <a href = "{{route('urines.create', $report)}}" class="btn btn-sm fw-bold btn-success">Next</a> --}}
                                            </div>
                                        </form>
                                    </div>
                                </div>
