                ...
                <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                            Insert Biochemistry Test Details
                        </h1>
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">Create Biochemistry Test</li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                class="text-decoration-none text-black">{{ $user->website }}</a>
                                    ...
                                    <div class="table-responsive px-10 pt-0 pb-10">
                                        ...
                                        <form data-kt-search-element="form" class="w-100 position-relative mt-10"
                                            method="POST" action="{{ route('biochemistry-reports.store') }}">
                                            @csrf
                                            ...
                                            <div class="row gx-10 gy-8 mx-0 mt-0">
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control my-2 py-2"
                                                        name="blood_sugar_f" value="{{ old('blood_sugar_f') }}"
                                                        data-kt-search-element="input"
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control my-2 py-2"
                                                        name="blood_sugar_pp" value="{{ old('blood_sugar_pp') }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span> mg/dl</span> --}}
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control my-2 py-2"
                                                        name="blood_sugar_r" value="{{ old('blood_sugar_r') }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span> mg/dl</span> --}}
                                                    @error('blood_sugar_r')
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control my-2 py-2"
                                                        name="blood_urea" value="{{ old('blood_urea') }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span> mg/dl</span> --}}
                                                    @error('blood_urea')
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="number" step="any" class="form-control my-2 py-2"
                                                        name="s_ceratinine" value="{{ old('s_ceratinine') }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span> mg/dl</span> --}}
                                                    @error('s_ceratinine')
                                                ...
                                                <div class="col-3 mt-0">
                                                    <p class="mb-0 py-4">(0.4-1.4)mg%</p>
                                                </div>
