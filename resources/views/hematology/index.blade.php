...
{{--                        <a href="#" class="btn btn-sm fw-bold bg-body btn-color-gray-700 btn-active-color-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Print Report</a>--}}
                        <a href="{{route('reports.index')}}" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">New Report</a>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-body p-15 pe-0 pb-0">
                                    <div class="table-responsive h-550px pe-15">
                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                            ...
                                            <tbody>
                                            {{$hematologies}}
                                            @forelse($hematologies as $hematology)
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="d-flex justify-content-start flex-column">
                                                                WBC: {{$hematology->wbc}}
                                                                <span class="text-gray-400 fw-semibold d-block fs-7">RBC: {{$hematology->rbc}}</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-end pe-13">
                                                        <span class="text-gray-600 fw-bold fs-6">{{$hematology->platelets}}</span>
                                                    </td>
                                                    <td class="text-end">
                                                    ...
                                                    <td class="text-end">
                                                        <a href="{{ route('hematologies.edit', $report)}}" class="btn btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
                                                            Edit
                                                        </a>
                                                    </td>
                                                </tr>
