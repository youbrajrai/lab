                ...
                <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">Create Urine Test</li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                class="text-decoration-none text-gray-800">{{ $user->website }}</a>
                                    ...
                                    <div class="table-responsive px-10 pt-0 pb-10 ">
                                        ...
                                        <form data-kt-search-element="form" class="w-100 position-relative mt-10"
                                            method="POST" action="{{ route('urine-reports.store') }}">
                                            @csrf
                                            ...
                                            <div class="row border gx-10 gy-8 w-lg-100 ms-0 mt-0">
                                                ...
                                                <div class="col-3 border-bottom border-end mt-0">
                                                    <input type="date" class="form-control my-2 py-2"
                                                        name="medical_examination_date" value="<?php echo date('Y-m-d'); ?>"
                                                        data-kt-search-element="input" />
                                                ...
                                                <div class="col-3 mt-0 border-end">
                                                    <input type="number" class="form-control my-2 py-2" name="lab"
                                            ...
                                            <div class="row gx-10 gy-8 mx-0 mt-0">
                                                ...
                                                <div class="col-6 mt-0">
                                                    <input type="text" step="any" class="form-control my-2 py-2"
                                                        name="transparency" value="{{ old('transparency') }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    @error('transparency')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                ...
                                                <div class="col-6 mt-0">
                                                    <input type="text" step="any" class="form-control my-2 py-2"
                                                        name="sp_gravity" value="{{ old('sp_gravity') }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    @error('sp_gravity')
                                                        <span class="invalid-feedback d-block" role="alert">
                                            ...
                                            <div class="row gx-10 gy-8 mx-0 mt-0">
                                                ...
                                                <div class="col-6 mt-0">
                                                    <input type="text" step="any" class="form-control my-2 py-2"
                                                        name="reaction" value="{{ old('reaction') }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    @error('reaction')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                ...
                                                <div class="col-6 mt-0">
                                                    <input type="text" step="any" class="form-control my-2 py-2"
                                                        name="albumin" value="{{ old('albumin') }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    @error('albumin')
                                                        <span class="invalid-feedback d-block" role="alert">
                                               ...
                                               {{-- <div class="col-6 mt-0">
                                                ...
                                                <div class="col-6 mt-0">
                                                    <input type="text" step="any" class="form-control my-2 py-2"
                                                        name="ketone_bodies" value="{{ old('ketone_bodies') }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    @error('ketone_bodies')
                                                        <span class="invalid-feedback d-block" role="alert">
                                                ...
                                                <div class="col-6 mt-0">
                                                    <input type="text" step="any" class="form-control my-2 py-2"
                                                        name="nitrite" value="{{ old('nitrite') }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    @error('nitrite')
                                                        <span class="invalid-feedback d-block" role="alert">
                                            ...
                                            <div class="row gx-10 gy-8 mx-0 mt-0">
                                                ...
                                                <div class="col-6 mt-0">
                                                    <input type="text" step="any" class="form-control my-2 py-2"
                                                        name="pus_cell" value="{{ old('pus_cell') }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span> /hpf</span> --}}
                                                    @error('pus_cell')
                                                ...
                                                <div class="col-6 mt-0">
                                                    <input type="text" step="any" class="form-control my-2 py-2"
                                                        name="epithelial_cells" value="{{ old('epithelial_cells') }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span> /hpf</span> --}}
                                                ...
                                                <div class="col-6 mt-0">
                                                    <input type="text" step="any" class="form-control my-2 py-2"
                                                        name="ca_oxalate" value="{{ old('ca_oxalate') }}"
                                                        data-kt-search-element="input"
                                                        style="width:50%; display: inline;">
                                                    {{-- <span> /hpf</span> --}}
                                                    @error('ca_oxalate')
