                                ...
                                <div class="card-body px-20 py-10">
                                    ...
                                    <div class="table-responsive px-10 pt-0 pb-10">
                                        ...
                                        <form data-kt-search-element="form" class="w-100 position-relative mt-10"
                                              method="POST" action="{{ route('stool-reports.store') }}">
                                            @csrf
                                            ...
                                            <div class="row gx-10 gy-8 mx-0 mt-0">
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="text" class="form-control py-2 my-2" name="consistency"
                                                           placeholder="Consistency" value="{{ old('consistency') }}"
                                                           data-kt-search-element="input"/>
                                                    @error('consistency')
                                                    <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="text" class="form-control py-2 my-2"
                                                           ...
                                                           value="{{ old('colour') }}" data-kt-search-element="input"/>
                                                    @error('colour')
                                                    <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="text" class="form-control py-2 my-2"
                                                           ...
                                                           value="{{ old('blood') }}" data-kt-search-element="input"/>
                                                    @error('blood')
                                                    <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="text" class="form-control py-2 my-2"
                                                           ...
                                                           value="{{ old('r_s') }}" data-kt-search-element="input"/>
                                                    @error('r_s')
                                                    <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="col-3 mt-0">
                                                    <input type="text" class="form-control py-2 my-2"
                                                           ...
                                                           value="{{ old('mucus') }}" data-kt-search-element="input"/>
                                                    @error('mucus')
                                                    <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="row gx-10 gy-8 mx-0 mt-0">
                                                ...
                                                <div class="col-4 mt-0">
                                                    ...
                                                    <input type="text" class="form-control py-2 my-2" name="cyst_of"
                                                           placeholder="Cyst of" value="{{ old('cyst_of') }}"
                                                           data-kt-search-element="input"/>
                                                    @error('cyst_of')
                                                    <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-4 mt-0">
                                                    ...
                                                    <input type="text" class="form-control py-2 my-2"
                                                           ...
                                                           value="{{ old('helmeinthic_parasite') }}"
                                                           data-kt-search-element="input"/>
                                                ...
                                                <div class="col-4 mt-0">
                                                    ...
                                                    <input type="text" class="form-control py-2 my-2" name="r_b_c"
                                                           placeholder="R.B.C" value="{{ old('r_b_c') }}"
                                                           data-kt-search-element="input"/>
                                                    @error('r_b_c')
                                                    <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-4 mt-0">
                                                    ...
                                                    <input type="text" class="form-control py-2 my-2" name="pus_cells"
                                                           placeholder="Pus Cells" value="{{ old('pus_cells') }}"
                                                           data-kt-search-element="input"/>
                                                    @error('pus_cells')
                                                    <span class="invalid-feedback d-block" role="alert">
                                                            <strong>{{ $message }}</strong>
