                ...
                <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">Stool Examination Reports</li>
                        </ul>
                    </div>
                                ...
                                <div class="card-body p-15 pe-0 pb-0">
                                    <div class="table-responsive h-550px pe-15">
                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                            ...
                                            <tbody>
                                                @forelse($stoolReports as $stoolReport)
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    {{ $stoolReport->name }}
                                                                    <span
                                                                        class="text-gray-400 fw-semibold d-block fs-7">{{ $stoolReport->nationality }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td class="text-end pe-13">
                                                            <a target="_blank"
                                                                href="{{ route('stool-reports.show', $stoolReport) }}"
                                                                class="btn btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
                                                                Print
                                                            </a>
                                                        </td>
                                                        <td class="text-end">
                                                            <a href="{{ route('stool-reports.edit', $stoolReport) }}"
                                                                class="btn btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
                                                                Edit
                                                            </a>
                                                        </td>
